...
1. Extrair handlers de objetivos/mini-expansões (`handleSelectObjective`, `handleDiscardObjective` e resoluções relacionadas) para hook dedicado, sem alterar fluxo online/local.
