...
export const commonForestCards: ForestCardDefinition[] = [
  commonCard("bosque_1", "Bosque 1", "bosque (1).png", "forest", ["fruit"]),
  commonCard("bosque_1_copy", "Bosque 1 - Copia", "bosque (1) - Copia.png", "forest", ["fruit"]),
  commonCard("bosque_5_copy", "Bosque 5 - Copia", "bosque (5) - Copia.png", "forest", ["fruit"]),
  commonCard("bosque_2", "Bosque 2", "bosque (2).png", "forest", ["egg"]),
  commonCard("bosque_2_copy", "Bosque 2 - Copia", "bosque (2) - Copia.png", "forest", ["egg"]),
  commonCard("bosque_2_copy_2", "Bosque 2 - Copia - Copia", "bosque (2) - Copia - Copia.png", "forest", ["egg"]),
  commonCard("bosque_3", "Bosque 3", "bosque (3).png", "forest", ["seed"]),
  commonCard("bosque_3_copy", "Bosque 3 - Copia", "bosque (3) - Copia.png", "forest", ["seed"]),
  commonCard("bosque_3_copy_2", "Bosque 3 - Copia - Copia", "bosque (3) - Copia - Copia.png", "forest", ["seed"]),
  commonCard("bosque_4", "Bosque 4", "bosque (4).png", "forest", ["meat"]),
  commonCard("bosque_4_copy", "Bosque 4 - Copia", "bosque (4) - Copia.png", "forest", ["meat"]),
  commonCard("bosque_4_copy_2", "Bosque 4 - Copia - Copia", "bosque (4) - Copia - Copia.png", "forest", ["meat"]),
  commonCard("campo_1", "Campo 1", "campos (1).png", "field", ["seed"]),
  commonCard("campo_1_copy", "Campo 1 - Copia", "campos (1) - Copia.png", "field", ["seed"]),
  commonCard("campo_1_copy_2", "Campo 1 - Copia - Copia", "campos (1) - Copia - Copia.png", "field", ["seed"]),
  commonCard("campo_2", "Campo 2", "campos (2).png", "field", ["meat"]),
  commonCard("campo_2_copy", "Campo 2 - Copia", "campos (2) - Copia.png", "field", ["meat"]),
  commonCard("campo_2_copy_2", "Campo 2 - Copia - Copia", "campos (2) - Copia - Copia.png", "field", ["meat"]),
  commonCard("campo_3", "Campo 3", "campos (3).png", "field", ["fruit"]),
  commonCard("campo_3_copy", "Campo 3 - Copia", "campos (3) - Copia.png", "field", ["fruit"]),
  commonCard("campo_3_copy_2", "Campo 3 - Copia - Copia", "campos (3) - Copia - Copia.png", "field", ["fruit"]),
  commonCard("campo_4", "Campo 4", "campos (4).png", "field", ["egg"]),
  commonCard("campo_4_copy", "Campo 4 - Copia", "campos (4) - Copia.png", "field", ["egg"]),
  commonCard("campo_4_copy_2", "Campo 4 - Copia - Copia", "campos (4) - Copia - Copia.png", "field", ["egg"]),
  commonCard("rio_1", "Rio 1", "rios (1).png", "river", ["seed"], riverChannel),
  commonCard("rio_2", "Rio 2", "rios (2).png", "river", ["meat"], riverChannel),
  commonCard("rio_3", "Rio 3", "rios (3).png", "river", ["meat"], riverBend),
  commonCard("rio_4", "Rio 4", "rios (4).png", "river", ["meat"], riverEnd),
  commonCard("rio_5", "Rio 5", "rios (5).png", "river", ["fruit"], riverBend),
  commonCard("rio_6", "Rio 6", "rios (6).png", "river", ["fruit"], riverChannel),
  commonCard("rio_7", "Rio 7", "rios (7).png", "river", ["fruit"], riverEnd),
  commonCard("rio_8", "Rio 8", "rios (8).png", "river", ["seed"], riverBend),
  commonCard("rio_9", "Rio 9", "rios (9).png", "river", ["egg"], riverEnd),
  commonCard("rio_10", "Rio 10", "rios (10).png", "river", ["egg"], riverChannel),
  commonCard("rio_11", "Rio 11", "rios (11).png", "river", ["egg"], riverBend),
...
export const initialForestCardCandidates: ForestCardDefinition[] = [
  ...
  initialCard("initial_2", "Inicial 2", "Inicial (2).png", "forest", ["egg"]),
  initialCard("initial_3", "Inicial 3", "Inicial (3).png", "forest", ["fruit"]),
  initialCard("initial_4", "Inicial 4", "Inicial (4).png", "forest", ["seed"]),
  initialCard("initial_5", "Inicial 5", "Inicial (5).png", "field", ["fruit"]),
  initialCard("initial_6", "Inicial 6", "Inicial (6).png", "field", ["seed"]),
  initialCard("initial_7", "Inicial 7", "Inicial (7).png", "field", ["meat"]),
